...
namespace eugraph::service::thrift {
...
std::string formatResultValue(const thrift_service::ResultValue& val) {
    switch (val.getType()) {
...
std::string propertyTypeToString(thrift_service::PropertyType t) {
    switch (t) {
