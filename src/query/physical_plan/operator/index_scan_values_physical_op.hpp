...
/// Leaf scan that reads vertex ids from a shared allowed-value list and probes
/// `vidx_{index_id}` for each value. Used as the indexed Tag source of a
/// reversed ListIndexJoin chain.
