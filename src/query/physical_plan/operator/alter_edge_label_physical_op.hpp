...
public:
    AlterEdgeLabelPhysicalOp(std::string label_name, std::vector<std::pair<std::string, PropertyType>> prop_defs,
                             IAsyncGraphMetaStore& meta, std::unordered_map<EdgeLabelId, EdgeLabelDef>& defs,
