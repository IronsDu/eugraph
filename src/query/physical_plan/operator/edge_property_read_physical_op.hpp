...
class EdgePropertyReadPhysicalOp : public PhysicalOperator {
public:
    EdgePropertyReadPhysicalOp(std::string variable, size_t col_idx, std::vector<uint16_t> edge_prop_ids,
