...
| [Demand-Pull-Lowering 设计](query/demand-pull-lowering-design.md) | 需求驱动的属性物化：SlotId 系统、六阶段管线、PEPlan、作用域感知的 canonical 解析 |
| [SlotId 架构设计](query/slot-id-design.md) | 全局唯一槽位标识符：动机、设计决策、物理布局映射、内部/用户槽位分区 |
