...
| [Binder + Chunk 执行引擎](query/engine/binder-chunk-design.md) | **[设计中]** Binder 语义分析、Catalog、FunctionRegistry、DataChunk、选择向量 |
| [Binder + Chunk 进度](query/engine/binder-chunk-progress.md) | 各模块实现状态与待办事项 |
