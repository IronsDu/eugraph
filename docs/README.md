...
| RPC 服务 | fbthrift 服务端，DDL 协调，流式 DML | `EuGraphHandler` | `src/program/server/` | [service/rpc-service.md] |
| Shell | 交互式 REPL（RPC 连接 server） | `ShellRepl`, `EuGraphRpcClient` | `src/program/shell/` | [program/design/server-shell-design.md] |
